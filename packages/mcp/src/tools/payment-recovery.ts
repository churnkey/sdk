...
export function paymentRecoveryTools(client: ChurnkeyClient): ToolDefinition[] {
  return [
    ...
    },
    {
      ...
      inputSchema: z.object({
        confirm: z.literal('remove_recovery_email').describe('Required confirmation literal.'),
        blueprintId,
        emailGuid: z.string().describe('Email guid from get_recovery_blueprint.'),
      }),
    ...
    },
    {
      ...
      inputSchema: z.object({
        confirm: z.literal('set_recovery_blueprint_enabled').describe('Required confirmation literal.'),
        blueprintId,

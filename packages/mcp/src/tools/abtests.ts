...
export function abTestTools(client: ChurnkeyClient): ToolDefinition[] {
  return [
    ...
    },
    {
      ...
      inputSchema: z.object({
        confirm: z.literal('create_ab_test').describe('Required confirmation literal.'),
    ...
    },
    {
      ...
      inputSchema: z.object({
        confirm: z.literal('start_ab_test').describe('Required confirmation literal.'),
        abTestId,
      }),
    ...
    },
    {
      ...
      inputSchema: z.object({
        confirm: z.literal('pause_ab_test').describe('Required confirmation literal.'),
        abTestId,
      }),
      annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: true },
      handler: async (args) => {
    ...
    },
    {
      ...
      inputSchema: z.object({
        confirm: z.literal('complete_ab_test').describe('Required confirmation literal.'),
        abTestId,
      }),
      annotations: { readOnlyHint: false, destructiveHint: true, openWorldHint: true },
      handler: async (args) => {
    ...
    },
    {
      ...
      inputSchema: z.object({
        confirm: z.literal('pick_winner').describe('Required confirmation literal.'),
        abTestId,
